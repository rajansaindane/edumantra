...
public class CustomlistAdapter extends BaseAdapter {
    ...
    public CustomlistAdapter(Common common, List<String> jokes) {
        this.common = common;
        this.jokes = jokes;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater inflator = (LayoutInflater) common.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
