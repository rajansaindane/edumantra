...
public class CoursesAfterDiplomaList extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_courses_after_diploma_list);
        get();
    }
    ...
    private void get() {
        ...
        String url = "http://192.168.43.227:7878/mahacareer/coursesafterten/58f0817cd3e2433a0c522b4d";
...
////        ArrayAdapter<String> adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, jokes);
        ListView list = ((ListView) findViewById(R.id.listdiploma));
